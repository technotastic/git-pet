...
# Git Pet post-commit hook script v3
...
if $CHANGES_DETECTED; then
    echo "[GitPet Hook] Changes detected in commit, running react --changes..." >&2
    git-pet react post-commit --changes || true
else
    echo "[GitPet Hook] No file changes detected comparing HEAD to parent, running react..." >&2
